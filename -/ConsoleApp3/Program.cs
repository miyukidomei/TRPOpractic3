...
namespace SimpleLibrarySystem
{
    ...
    class Program
    {
        ...
        static void AddTestData()
        {
            ...
            books.Add(new Book { Id = nextBookId++, Title = "Изощренное Убийство", Author = "Ф. Д. Джеймс", Year = 1963 });
            ...
            readers.Add(new Reader { Id = nextReaderId++, Name = "Максим Адреев", Email = "andreeeeeeev1@mail.com" });
            readers.Add(new Reader { Id = nextReaderId++, Name = "Валерия Миладзе", Email = "marmeladze@mail.com" });
        }
